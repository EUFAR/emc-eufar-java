...
public class ScrollableTabLayoutPanel extends TabLayoutPanel {
    ...
    private void initScrollButtons() {
        ...
        scrollLeftButton.setTitle("Navigate between tabs to the left");
        ...
        scrollRightButton.setTitle("Navigate between tabs to the right");
        ...
        menuButton.setTitle("Show all tabs");
